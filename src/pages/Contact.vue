        ...
        <div class="flex flex-col gap-8 fade-up" style="transition-delay:0.25s;">
          ...
          <div class="p-8 card-glass">
            ...
            <div class="flex flex-col gap-5">
              ...
              <a href="tel:+359876566094" class="contact-item" data-cursor>
                ...
                <div>
                  <div class="text-[11px] text-text-dim uppercase tracking-widest mb-0.5">{{ t('contact.phoneLabel') }}</div>
              ...
              <div class="contact-item">
                ...
                <div>
                  <div class="text-[11px] text-text-dim uppercase tracking-widest mb-0.5">{{ t('contact.locationLabel') }}</div>
                  <div class="text-[15px]">{{ t('contact.locationVal') }}</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="p-8 card-glass">
            ...
            <div class="flex flex-col gap-4">
              <a href="https://www.linkedin.com/company/inrait/?" target="_blank" rel="noopener" class="contact-item" data-cursor>
                <div class="contact-icon">
          ...
          <div class="p-6 rounded-2xl" style="background:rgba(164,224,75,0.05);border:1px solid rgba(164,224,75,0.2);">
            <div class="flex items-center gap-3 mb-3">
              ...
              <span class="font-semibold text-[15px]" style="color:var(--accent);">{{ t('contact.availTitle') }}</span>
            </div>
...
async function handleSubmit() {
  ...
  try {
    ...
    errorMsg.value = t('contact.errorFail')
  } finally {
    loading.value = false
  }
}
