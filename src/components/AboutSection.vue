<template>
  <section id="about" class="relative px-6 py-32 overflow-hidden">
    ...
    <div class="max-w-[1080px] mx-auto relative z-10">
      ...
      <!-- Studio statement — full width, large -->
      <p class="fade-up text-[clamp(18px,2.5vw,26px)] leading-relaxed mb-20 max-w-3xl"
        ...
        INRAIT is a boutique digital studio based in Sofia. We work with hospitality businesses, service providers, and growing brands across Bulgaria and Europe — building the digital infrastructure they need to compete and convert.
      </p>
      ...
      <div class="about-strip fade-up" style="transition-delay:0.45s;">
        <div class="flex items-center gap-3 text-text-muted text-[14px]">
          ...
          Sofia, Bulgaria · Serving clients across the EU · Remote-ready
        </div>
